...
来源:https://lwn.net/Articles/379903/
...
- name
  ...
  \- the name of the tracepoint to be created.
...
- prototype
  ...
  \- the prototype for the tracepoint callbacks
...
- args
  ...
  \- the arguments that match the prototype.
...
- struct
  ...
  \- the structure that a tracer could use (but is not required to) to store the data passed into the tracepoint.
...
- assign
  ...
  \- the C-like way to assign the data to the structure.
...
- __field(type, name)
  ...
  \- this defines a normal structure element, like
