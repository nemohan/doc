...
https://github.com/prometheus/prometheus/blob/release-2.26/tsdb/docs/format/index.md
...
The sequence of label index sections is finalized by a [label offset table](https://github.com/prometheus/prometheus/blob/release-2.26/tsdb/docs/format/index.md#label-offset-table) containing label offset entries that points to the beginning of each label index section for a given label name.
...
The sequence of postings sections is finalized by a [postings offset table](https://github.com/prometheus/prometheus/blob/release-2.26/tsdb/docs/format/index.md#postings-offset-table) containing postings offset entries that points to the beginning of each postings section for a given label pair.
