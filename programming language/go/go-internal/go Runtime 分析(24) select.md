...
osharian committed on 19 Dec 2014
pollslice := slice{unsafe.Pointer(sel.pollorder), int(sel.ncase), int(sel.ncase)}
 	pollorder := *(*[]uint16)(unsafe.Pointer(&pollslice))		 (unsafe.Pointer(&pollslice))
...
func makechan(t *chantype, size int64) *hchan {
 804aeb0:	65 8b 0d 00 00 00 00 	mov    %gs:0x0,%ecx
 804aeb7:	8b 89 fc ff ff ff    	mov    -0x4(%ecx),%ecx
 804aebd:	3b 61 08             	cmp    0x8(%ecx),%esp
 804aec0:	0f 86 73 02 00 00    	jbe    804b139 <runtime.makechan+0x289>
 804aec6:	83 ec 28             	sub    $0x28,%esp
	elem := t.elem
 804aec9:	8b 4c 24 2c          	mov    0x2c(%esp),%ecx
 804aecd:	8b 49 20             	mov    0x20(%ecx),%ecx
 804aed0:	89 4c 24 18          	mov    %ecx,0x18(%esp)

	// compiler checks this but be safe.
	if elem.size >= 1<<16 {
 804aed4:	8b 11                	mov    (%ecx),%edx
 804aed6:	81 fa 00 00 01 00    	cmp    $0x10000,%edx
 804aedc:	0f 83 3f 02 00 00    	jae    804b121 <runtime.makechan+0x271>
		throw("makechan: invalid channel element type")
	}
	if hchanSize%maxAlign != 0 || elem.align > maxAlign {
 804aee2:	0f b6 59 0d          	movzbl 0xd(%ecx),%ebx
 804aee6:	80 fb 08             	cmp    $0x8,%bl
 804aee9:	0f 87 1a 02 00 00    	ja     804b109 <runtime.makechan+0x259>
		throw("makechan: bad alignment")
	}
	if size < 0 || int64(uintptr(size)) != size || (elem.size > 0 && uintptr(size) > (_MaxMem-hchanSize)/elem.size) {
 804aeef:	8b 5c 24 30          	mov    0x30(%esp),%ebx
 804aef3:	85 db                	test   %ebx,%ebx
 804aef5:	87 dd                	xchg   %ebx,%ebp
 804aef7:	0f 92 c3             	setb   %bl
 804aefa:	87 dd                	xchg   %ebx,%ebp
 804aefc:	8b 74 24 34          	mov    0x34(%esp),%esi
 804af00:	85 f6                	test   %esi,%esi
 804af02:	87 df                	xchg   %ebx,%edi
 804af04:	0f 94 c3             	sete   %bl
 804af07:	87 df                	xchg   %ebx,%edi
 804af09:	97                   	xchg   %eax,%edi
 804af0a:	88 44 24 13          	mov    %al,0x13(%esp)
 804af0e:	97                   	xchg   %eax,%edi
 804af0f:	21 fd                	and    %edi,%ebp
 804af11:	85 f6                	test   %esi,%esi
 804af13:	89 f8                	mov    %edi,%eax
 804af15:	87 df                	xchg   %ebx,%edi
 804af17:	0f 9c c3             	setl   %bl
 804af1a:	87 df                	xchg   %ebx,%edi
 804af1c:	09 fd                	or     %edi,%ebp
 804af1e:	95                   	xchg   %eax,%ebp
 804af1f:	84 c0                	test   %al,%al
 804af21:	95                   	xchg   %eax,%ebp
 804af22:	0f 85 9a 01 00 00    	jne    804b0c2 <runtime.makechan+0x212>
 804af28:	85 f6                	test   %esi,%esi
 804af2a:	0f 85 92 01 00 00    	jne    804b0c2 <runtime.makechan+0x212>
 804af30:	85 d2                	test   %edx,%edx
 804af32:	0f 86 c8 01 00 00    	jbe    804b100 <runtime.makechan+0x250>
 804af38:	89 c5                	mov    %eax,%ebp
 804af3a:	b8 c7 ff ff ff       	mov    $0xffffffc7,%eax
 804af3f:	89 d7                	mov    %edx,%edi
 804af41:	31 d2                	xor    %edx,%edx
 804af43:	f7 f7                	div    %edi
 804af45:	39 c3                	cmp    %eax,%ebx
 804af47:	0f 87 75 01 00 00    	ja     804b0c2 <runtime.makechan+0x212>
