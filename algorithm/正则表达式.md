...
The NFA for the concatenation *e*1*e*2 connects the final arrow of the *e*1 machine to the start of the *e*2 machine:

![Concatenation NFA](https://swtch.com/~rsc/regexp/fig5.png)

The NFA for the alternation *e*1`|`*e*2 adds a new start state with a choice of either the *e*1 machine or the *e*2 machine.
